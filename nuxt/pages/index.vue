  ...
  <div class="font-sans text-gray-900 bg-gray-100 scroll-smooth">
    ...
    <header id="accueil" class="relative min-h-screen flex flex-col items-center justify-center text-center py-32 px-4 bg-cover bg-center bg-gray-500">
      ...
      <div class="relative z-10 pointer-events-none">
        ...
        <p class="text-white text-xl md:text-2xl max-w-2xl mx-auto mb-4">
          Réparation PC, montage, cours et développement web à Dax et dans les Landes
        </p>
        <p class="text-white text-lg md:text-xl max-w-2xl mx-auto mb-6">
          Services rapides et professionnels pour particuliers et professionnels
        </p>
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div class="text-lg text-gray-700 leading-relaxed space-y-4">
            ...
            <p>
              <strong>Basé à Dax dans les Landes</strong>, je propose également des services de dépannage informatique, 
              réparation PC, montage et cours pour particuliers et professionnels de la région.
            </p>
            <p>
              Que ce soit pour développer une application from scratch, moderniser un outil existant, accompagner une équipe ou 
              dépanner votre ordinateur, je suis toujours prêt à relever de nouveaux défis.
            </p>
          </div>
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-xl border border-gray-200 mb-6">
          ...
          <p class="text-center text-gray-600 text-sm">
            Principales villes desservies : Dax, Mont-de-Marsan, Saint-Paul-lès-Dax, Tarnos, Anglet, Bayonne et dans un rayon de 30km autour de Dax.
          </p>
        </div>
        ...
        <div class="mt-10 text-center">
          <button 
            @click="goTo('contact')" 
            class="bg-black text-white px-5 py-3 rounded-md hover:bg-[#fe007b]"
          >
            Me contacter pour un dépannage
          </button>
        </div>
      </div>
    </section>
...
useSeoMeta({
  ...
  description: 'Dépannage informatique professionnel à Dax et dans les Landes. Réparation PC, montage, cours informatique et développement web. Services rapides et fiables.',
  keywords: 'dépannage informatique Dax, réparation PC Dax, informatique Dax, réparation ordinateur Dax, montage PC Dax, cours informatique Dax, développement web Dax, Landes',
  ogTitle: 'Dépannage Informatique Dax - Valentin Thiebaut',
  ogDescription: 'Services professionnels de dépannage informatique à Dax. Réparation PC, montage, cours et développement web.',
  ogType: 'website',
  ogLocale: 'fr_FR',
  twitterCard: 'summary_large_image',
})

// Structured Data JSON-LD pour LocalBusiness (SEO local)
const structuredData = computed(() => {
  return JSON.stringify({
    ...
    "description": "Dépannage informatique professionnel à Dax et dans les Landes. Réparation PC, montage, cours informatique et développement web.",
    "serviceArea": {
      "@type": "City",
      "name": "Dax"
    },
    "areaServed": {
      "@type": "City",
      "name": ["Dax", "Mont-de-Marsan", "Saint-Paul-lès-Dax", "Tarnos", "Anglet", "Bayonne"]
    },
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Dépannage informatique Dax",
            "description": "Réparation PC, nettoyage, optimisation, suppression de virus"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Montage PC Dax",
            "description": "Montage et configuration de PC sur mesure"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Cours informatique Dax",
            "description": "Formation bureautique et développement web"
          }
        }
      ]
    }
